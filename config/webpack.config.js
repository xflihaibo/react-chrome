...
module.exports = function (webpackEnv) {
    ...
    paths.appIndexJs.forEach((e) => {
        entry[e.name] = [isEnvDevelopment && !shouldUseReactRefresh && webpackDevClientEntry, e.path].filter(Boolean);
    });
    ...
    return {
        ...
        output: {
            ...
            filename: isEnvProduction ? 'static/js/[name]/[name].js' : isEnvDevelopment && 'static/js/[name]/[name].bundle.js',
            chunkFilename: isEnvProduction ? 'static/js/[name]/[name].chunk.js' : isEnvDevelopment && 'static/js/[name]/[name].chunk.js',
        ...
        plugins: [
            ...
            //             return manifest;
            //         }, seed);
            //         console.log('asset-manifest', entrypoints);
